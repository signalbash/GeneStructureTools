...
`nmd_prob_bygroup_x`: minimum NMD probability in first set of transcripts (normalTranscripts)
`nmd_prob_bygroup_y`: minimum NMD probability in second set of transcripts (skippedExonTranscripts)
