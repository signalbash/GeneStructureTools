...
summary <- whippetTranscriptChangeSummary(wds,
gtf.exons = gtf.exons,
...
skippedExonTranscripts <- skipExonInTranscript(wds,
...
retainedIntronTranscripts <- addIntronInTranscript(wds.ri,
                                                   exons.ri, 
                                                   gtf.exons = gtf.exons, 
                                                   glueExons = TRUE)
...
gtf.transcripts = gtf.transcripts,
BSgenome = g,
NMD =TRUE # ignore nonsense mediated decay
)
```
